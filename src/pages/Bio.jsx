  ...
  return (
    <>
      <div className="absolute left-0 top-0 flex h-screen w-screen flex-col items-center justify-center p-10">
        <div className="relative -top-5 z-40 overflow-y-auto text-center">
          <h2 className="my-2 font-hypo text-[46px] font-bold">BIO</h2>
          <div className="max-w-[600px]  md:max-w-[750px] md:text-lg">
            ...
            <strong> MathemEthic</strong> was released on <strong>Bandcamp</strong> late 2022 check
            it out if you haven’t already, also available on
            <strong> Spotify</strong>. Earlier this year we trod the boards for the first time
            supporting <strong>Die Kur</strong> and more recently <strong>Die Ego</strong>. Other
            ...
            stay and there will be much more to come...
          </div>
        </div>
      </div>
