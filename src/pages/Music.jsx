const Music = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="z-50 my-5 font-hypo text-[46px] font-bold">MUSIC</h2>
        <div className="z-50 grid grid-flow-row gap-6 lg:grid-flow-col [&_iframe]:min-w-[300px] xs:[&_iframe]:min-w-[350px] sm:[&_iframe]:min-w-[600px] md:[&_iframe]:min-h-[325px] md:[&_iframe]:min-w-[500px] xl:[&_iframe]:min-w-[600px]">
